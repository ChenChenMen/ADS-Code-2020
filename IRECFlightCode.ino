...
void setup() {
  ...
  myServo.write(60);
  myServo.write(62); // Keeps the servo at the minimum actuation in the rocket without pushing on the inside
...
/*
  This method dectects burnout of the rocket motor either through a threshold
  acceleration or through a time period
